...
<div class="login-box">
    ...
    <div class="login-body">
        ...
        <form name="passChange" action="<?php echo BASE_URL ?>index.php?url=userController/passwordUpdate/<?php echo $data ?>" onsubmit= "return validateForm()" method="POST">
...
<script>
    function validateForm() {
        var x = document.forms["passChange"]["new_password"].value;
        var y= document.forms["passChange"]["confirm_new_password"].value;
        if (x != y) {

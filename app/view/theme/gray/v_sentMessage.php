                                            ...
                                            <td>
                                                <div class="media"><a href="#" class="pull-left"> <img alt=""
                                                    ...
                                                    <div class="media-body"><span
                                                        ...
                                                        <h4 class="text-primary"><?php echo $value['user_first_name'] . " " . $value['user_last_name']; ?></h4>
                                                        <small class="text-muted"></small>
                                                        <p class="email-summary">
                                                            <strong><?php echo $value['message_subject']; ?></strong> <?php echo $value['message_detail']; ?>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>

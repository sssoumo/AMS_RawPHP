        ...
        <div class="panel-heading">
            <div style="max-width: 600px; margin: 0 auto">
                ...
                <div class="form-group row" style="text-align: center">
                    <div class="col-md-6" style="display: inline-block; padding-left: 150px;">
                        <button type="submit" name="register"
                                class="btn btn-success"><?php echo $data['btn_action'] ?></button>
                    </div>
                    <div class="col-md-6" style="display: inline-block; padding-right: 150px;">
                        <a href="?url=userController/users" class="btn btn-danger">Cancel</a>
                    </div>
                </div>
...
<div class="col-lg-7">
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <table class="table table-striped" id="data_table" class="table table-striped table-bordered" cellspacing="0"
                   width="100%">
                <thead>
                <tr>
                    <th>#</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <a href="<?php echo BASE_URL ?>index.php?url=userController/userDelete/<?php echo $value['id']; ?>"
